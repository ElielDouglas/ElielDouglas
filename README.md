...
![Estatísticas do GitHub](https://github-readme-stats.vercel.app/api?username=ElielDouglas&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true)
...
```typescript
const eliel = {
  role: "Backend Developer @ Raro Labs",
  focus: ["Node.js", "NestJS", "TypeScript"],
  languages: ["TypeScript", "JavaScript", "PHP"],
  backend: {
    runtime: ["Node.js"],
    frameworks: ["NestJS", "Express", "Laravel"],
    databases: ["PostgreSQL", "MySQL", "MongoDB"],
    orms: ["Prisma", "TypeORM", "Eloquent"],
    patterns: ["Clean Architecture", "SOLID", "DDD", "Design Patterns"]
  },
  devOps: ["AWS", "Docker", "Kubernetes", "CI/CD"],
  testing: ["Jest", "Vitest", "SonarQube", "TDD", "BDD"],
  education: {
    postGrad: "Testes de Software",
    degree: "Análise e Desenvolvimento de Sistemas"
  },
  currentFocus: "APIs escaláveis com NestJS e arquitetura backend",
  funFact: "Café + TypeScript = código limpo e testável ☕️🧪"
};
```
...
- 🚀 APIs escaláveis e performáticas
