...
const eliel = {
  ...
  technologies: {
    ...
    testing: ["Vitest", "Jest", "SonarQube", "TDD", "BDD"],
  ...
  currentFocus: "Arquitetura de Software e Qualidade de Código",
  funFact: "Adoro transformar café em código limpo e testável! ☕️🧪"
};
```
